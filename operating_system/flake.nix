{
  description = ''
    NixOS system configuration for Raspberry Pi boards
    using nixos-raspberrypi for the TSYP challenge.
  '';
    ...
    in {
      ...
      nixosConfigurations = let
        users-config-stub = ({ config, ... }: {
          ...
          services.getty.autologinUser = "autosubsystem";
          ...
          nix.settings.trusted-users = [ "autosubsystem" ];
